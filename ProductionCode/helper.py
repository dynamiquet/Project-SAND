...
def get_string_rating(int_rating):
    ...
    in_rating_dict = {0:"Insufficient Data", 1:"Not Applicable", 2:"No Rating", 3:"Very Low", 4:"Relatively Low", 5:"Relatively Moderate",
                     6:"Relatively High", 7:"Very High"}
    
    # Revert ratings for back into data hazards rating labels
    string_rating = in_rating_dict[int_rating]
